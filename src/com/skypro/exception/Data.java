...
public class Data {
    ...
    private static void check(String login,
        ...
        if (validate(login)) {
            throw new WrongLoginException("Логин должен содержать только латинсуие буквы, цифры и знак подчеркивания!");
        }
        if (validate(password)) {
            throw new WrongLoginException("Пароль должен содержать только латинсуие буквы, цифры и знак подчеркивания!");
        }
